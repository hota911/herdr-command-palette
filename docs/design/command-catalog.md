...
- `README.md` and `README.ja.md`: document, for users, the available commands, requirements,
  installation, and what is out of scope.
...
how it's reflected in fzf's ordering are decided in a separate design. This requirement is
tracked as [Issue #1](https://github.com/hota911/herdr-command-palette/issues/1).
